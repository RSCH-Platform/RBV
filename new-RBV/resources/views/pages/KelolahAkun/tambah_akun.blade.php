            ...
            <div class="bg-white rounded-[30px] shadow-2xl p-10 md:p-14 border border-gray-50">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <button type="button"
                                ...
                                text-gray-400 hover:text-gray-600 transition p-0.5">
                    ...
                    <div>
                        ...
                        <div id="msg-error"
                            class="hidden mt-2 px-4 py-2.5 bg-red-100
                            text-red-700 rounded-xl flex items-center gap-2 text-sm">

                            Password dan konfirmasi password tidak cocok.
                        </div>

                        <div id="msg-ok"
                            class="hidden mt-2 px-4 py-2.5 bg-green-100
                            text-green-700 rounded-xl flex items-center gap-2 text-sm">
                    ...
                    <div class="flex justify-center mt-10">
                        <button type="submit"
                            class="bg-[#2B3A8C] text-white font-bold
                            py-3 px-12 rounded-lg hover:bg-blue-800 transition">
