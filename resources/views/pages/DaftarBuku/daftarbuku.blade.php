                ...
                <form method="GET" action="{{ route('books.index') }}" class="flex-1 sm:flex-none">
                    <div class="relative group">
                        ...
                        <div class="absolute right-0 top-0 h-[44px] sm:h-[49px] w-[40px] sm:w-[43px]
                                    ...
                                    transition">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-[20.505786895751953px] h-[20.5079345703125px]"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                        </div>
                    </div>
                </form>
